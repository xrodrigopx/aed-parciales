...
1. Si la fila 0 del vector ya contiene el árbol parcialmente ordenado, aplicando el algoritmo de **HEAPSORT**, ordena el mismo mostrando todas las iteraciones.
2. ¿Cuál es el orden del tiempo de ejecución?

**Vector inicial (fila 0):**

| 1  | 2  | 3  | 4  | 5  | 6  | 7  | 8  | i |
|----|----|----|----|----|----|----|----|----|
| 97 | 19 | 61 | 07 | 04 | 25 | 02 | 06 | 0 |
