...
// Utilidad extra para imprimir por consola matrices de forma prolija (con formato de grilla)
public final class PrettyGrid {
    ...
    public static <V, D> void printGraphMatrix(
        ...
        for (V v : vs) {
            ...
            if (vertexLabel == null) {
                ...
                label = vertexLabel.apply(v);
            }
            labels.add(label);
        }

        // formateador de celdas por defecto
        CellFormat<Object> fmtCelda = cellFmt != null ? (CellFormat<Object>) cellFmt : new CellFormat<Object>() {
    ...
    public static <V, D> void printGraphMatrix(IGraph<V, D> graph) {
        PrettyGrid.printGraphMatrix(graph, new java.util.function.Function<V, String>() {
    ...
    public static <V, D> void printGraphMatrix(
        ...
        CellFormat<Object> fmtDefecto = new CellFormat<Object>() {
            public String format(Object o) {
                return o.toString();
            }
            public Align align() {
