...
public abstract class AbstractTArbolGenericoTest extends TestCase {
    ...
    private List<Integer> recorrerPreOrden(TArbolGenerico<Integer> arbol) {
        ...
        arbol.preOrden(new java.util.function.Consumer<Integer>() {
            public void accept(Integer dato) {
                resultado.add(dato);
            }
        });
        return resultado;
    ...
    private List<Integer> recorrerInOrden(TArbolGenerico<Integer> arbol) {
        final List<Integer> resultado = new ArrayList<>();
        arbol.inOrden(new java.util.function.Consumer<Integer>() {
            public void accept(Integer dato) {
                resultado.add(dato);
            }
        });
    ...
    private List<Integer> recorrerPostOrden(TArbolGenerico<Integer> arbol) {
        final List<Integer> resultado = new ArrayList<>();
        arbol.postOrden(new java.util.function.Consumer<Integer>() {
            public void accept(Integer dato) {
                resultado.add(dato);
            }
        });
